                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='Link to the terms under which users may use your online service. By default, this includes the "Commune CC Conditions of Use (End Users)" explaining the terms under which Commune CC software is provided to end users. If you change the default link to add your own terms for using the service you provide, your new terms must include a link to the default terms so end users are aware of the Commune CC Conditions of Use (End User) for Commune CC software.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='Link to About page for more information on your Commune CC deployment, for example its purpose and audience within your organization. Defaults to Commune CC information page.'
                        />
                    }

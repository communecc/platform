...
class LicenseSettings extends React.Component {
    ...
    render() {
        ...
        if (global.window.mm_license.IsLicensed === 'true') {
            ...
            edition = 'Commune CC Enterprise Edition. Enterprise features on this server have been unlocked with a license key and a valid subscription.';
            licenseType = (
                <div>
                    <p>
                    ...
                    <br/>
                    {'See also '}<a href='https://about.youcommune.com/enterprise-edition-terms/'>{'Enterprise Edition Terms of Service'}</a>{' and '}<a href='https://about.youcommune.com/privacy/'>{'Privacy Policy.'}</a>
                </div>
            );
            ...
            edition = (
                <p>
                    {'Commune CC Enterprise Edition. Unlock enterprise features in this software through the purchase of a subscription from '}
                    <a
                        target='_blank'
                        rel='noopener noreferrer'
                        href='https://youcommune.com/'
                    >
                        {'https://youcommune.com/'}
                    </a>
                </p>
            );
                ...
                <div className='col-sm-8'>
                    ...
                    <p className='help-text no-margin'>
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='Upload a license key for Commune CC Enterprise Edition to upgrade this server. <a href="http://youcommune.com" target="_blank">Visit us online</a> to learn more about the benefits of Enterprise Edition or to purchase a key.'
                        />
                    </p>
                </div>
            );

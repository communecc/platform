        ...
        if (this.state.pushNotificationServerType === PUSH_NOTIFICATIONS_OFF) {
            sendHelpText = (
                <FormattedHTMLMessage
                    ...
                    defaultMessage='Please see <a href="http://docs.youcommune.com/deployment/push.html#push-notifications-and-mobile-devices" target="_blank">documentation on push notifications</a> to learn more about setup options.'
                />
            );
            ...
            pushServerHelpText = (
                <FormattedHTMLMessage
                    ...
                    defaultMessage='Download <a href="https://itunes.apple.com/us/app/mattermost/id984966508?mt=8" target="_blank">Commune CC iOS app</a> from iTunes. Download <a href="https://play.google.com/store/apps/details?id=com.mattermost.mattermost&hl=en" target="_blank">Commune CC Android app</a> from Google Play. Learn more about the <a href="http://docs.youcommune.com/deployment/push.html#hosted-push-notifications-service-hpns" target="_blank">Commune CC Hosted Push Notification Service</a>.'
                />
            );
            ...
            pushServerHelpText = (
                <FormattedHTMLMessage
                    ...
                    defaultMessage='Download <a href="https://itunes.apple.com/us/app/mattermost/id984966508?mt=8" target="_blank">Commune CC iOS app</a> from iTunes. Download <a href="https://play.google.com/store/apps/details?id=com.mattermost.mattermost&hl=en" target="_blank">Commune CC Android app</a> from Google Play. Learn more about the <a href="http://docs.youcommune.com/deployment/push.html#test-push-notifications-service-tpns" target="_blank">Commune CC Test Push Notification Service</a>.'
                />
            );
        } else {
            pushServerHelpText = (
                <FormattedHTMLMessage
                    ...
                    defaultMessage='Learn more about compiling and deploying your own mobile apps from an <a href="http://docs.youcommune.com/deployment/push.html#enterprise-app-store-eas" target="_blank">Enterprise App Store</a>.'
                />
            );
        }
                ...
                <div className='form-group'>
                    ...
                    <div className='col-sm-8'>
                        ...
                        <FormattedHTMLMessage
                            ...
                            defaultMessage=' I understand and accept the Commune CC Hosted Push Notification Service <a href="https://about.youcommune.com/hpns-terms/" target="_blank">Terms of Service</a> and <a href="https://about.youcommune.com/hpns-privacy/" target="_blank">Privacy Policy</a>.'
                        />
                    </div>
                </div>
            );
        ...
        return (
            ...
            >
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.email.pushServerEx', 'E.g.: "http://push-test.youcommune.com"')}

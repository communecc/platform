        ...
        return (
            <SettingsGroup>
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.service.siteURLExample', 'Ex "https://youcommune.example.com:1234"')}
                    helpText={
                        <FormattedHTMLMessage
                            id='admin.service.siteURLDescription'
                            defaultMessage='The URL, including port number and protocol, that users will use to access Commune CC. This field can be left blank unless you are configuring email batching in <b>Notifications > Email</b>. When blank, the URL is automatically configured based on incoming traffic.'
                        />
                    }

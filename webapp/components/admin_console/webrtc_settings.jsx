        ...
        return (
            <h3>
                <FormattedMessage
                    ...
                    defaultMessage='Commune CC WebRTC (Beta)'
                />
            </h3>
        );
    }
            ...
            <div className='form-group'>
                ...
                <div className='col-sm-8'>
                    ...
                    <FormattedHTMLMessage
                        ...
                        defaultMessage=' I understand and accept the Commune CC Hosted WebRTC Service <a href="https://about.youcommune.com/webrtc-terms/" target="_blank">Terms of Service</a> and <a href="https://about.youcommune.com/webrtc-privacy/" target="_blank">Privacy Policy</a>.'
                    />
                </div>
            </div>
        );
        ...
        return (
            <SettingsGroup>
                <BooleanSetting
                    ...
                    label={
                        <FormattedMessage
                            ...
                            defaultMessage='Enable Commune CC WebRTC: '
                        />
                    }
                    helpText={
                        <FormattedHTMLMessage
                            id='admin.webrtc.enableDescription'
                            defaultMessage='When true, Commune CC allows making <strong>one-on-one</strong> video calls. WebRTC calls are available on Chrome, Firefox and Commune CC Desktop Apps.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.webrtc.gatewayWebsocketUrlExample', 'Ex "wss://webrtc.youcommune.com:8189"')}
                    helpText={
                        <FormattedMessage
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.webrtc.gatewayAdminUrlExample', 'Ex "https://webrtc.youcommune.com:7089/admin"')}
                    helpText={
                        <FormattedMessage
                            ...
                            Commune CC WebRTC uses this URL to obtain valid tokens for each peer to establish the connection.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.webrtc.stunUriExample', 'Ex "stun:webrtc.youcommune.com:5349"')}
                    helpText={
                        <FormattedMessage
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.webrtc.turnUriExample', 'Ex "turn:webrtc.youcommune.com:5349"')}
                    helpText={
                        <FormattedMessage

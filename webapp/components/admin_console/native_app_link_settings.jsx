        ...
        return (
            <h3>
                <FormattedMessage
                    ...
                    defaultMessage='Commune CC App Links'
                />
            </h3>
        );
    }
                ...
                <TextSetting
                    ...
                    label={
                        <FormattedMessage
                            ...
                            defaultMessage='Commune CC Apps Download Page Link:'
                        />
                    }
                    helpText={
                        <FormattedMessage
                            id='admin.customization.appDownloadLinkDesc'
                            defaultMessage='Add a link to a download page for the Commune CC apps. When a link is present, an option to "Download Commune CC Apps" will be added in the Main Menu so users can find the download page. Leave this field blank to hide the option from the Main Menu.'
                        />
                    }

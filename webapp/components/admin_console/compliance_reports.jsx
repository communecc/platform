                ...
                <div className='row'>
                    ...
                    <div className='col-sm-3 col-md-2 form-group'>
                        ...
                        <input
                            ...
                            id='from'
                            ref='from'
                            placeholder={Utils.localizeMessage('admin.compliance_reports.from_placeholder', 'E.g. "2017-03-11"')}
                        />
                    </div>
                    <div className='col-sm-3 col-md-2 form-group'>
                        <label>
                        ...
                        <input
                            ...
                            id='to'
                            ref='to'
                            placeholder={Utils.localizeMessage('admin.compliance_reports.to_placeholder', 'E.g. "2017-03-15"')}
                        />
                    </div>
                </div>
                <div className='row'>

                ...
                <RemoveFileSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='Remove the certificate used to generate the signature on a SAML request to the Identity Provider for a service provider initiated SAML login, when Commune CC is the Service Provider.'
                        />
                    }
                ...
                <FileUploadSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The certificate used to generate the signature on a SAML request to the Identity Provider for a service provider initiated SAML login, when Commune CC is the Service Provider.'
                        />
                    }
                    uploadingText={Utils.localizeMessage('admin.saml.uploading.certificate', 'Uploading Certificate...')}
                    disabled={!this.state.enable || !this.state.encrypt}
                ...
                <div className='banner'>
                    <div className='banner__content'>
                        <FormattedMessage
                            ...
                            defaultMessage='If a user attribute changes on the SAML server it will be updated the next time the user enters their credentials to log in to Commune CC. This includes if a user is made inactive or removed from a SAML Identity Provider. Remote logout with SAML servers is considered in a future release.'
                        />
                    </div>
                </div>
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='When true, Commune CC allows login using SAML. Please see <a href="http://docs.youcommune.com/deployment/sso-saml.html" target="_blank">documentation</a> to learn more about configuring SAML for Commune CC.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The URL where Commune CC sends a SAML request to start login sequence.'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When true, Commune CC verifies that the signature sent from the SAML Response matches the Service Provider Login URL'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When true, Commune CC will decrypt SAML Assertions encrypted with your Service Provider Public Certificate.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The attribute in the SAML Assertion that will be used to populate the email addresses of users in Commune CC.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The attribute in the SAML Assertion that will be used to populate the username field in Commune CC.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the first name of users in Commune CC.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the last name of users in Commune CC.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the nickname of users in Commune CC.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the language of users in Commune CC.'
                        />
                    }

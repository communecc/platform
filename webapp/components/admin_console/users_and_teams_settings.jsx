        ...
        return (
            <SettingsGroup>
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.team.restrictExample', 'Ex "corp.youcommune.com, youcommune.com"')}
                    helpText={
                        <FormattedMessage
                            id='admin.team.restrictDescription'
                            defaultMessage='Teams and user accounts can only be created from a specific domain (e.g. "youcommune.com") or list of comma-separated domains (e.g. "corp.youcommune.com, youcommune.com").'
                        />
                    }
                ...
                <DropdownSetting
                    ...
                    values={[
                        {value: RESTRICT_DIRECT_MESSAGE_ANY, text: Utils.localizeMessage('admin.team.restrict_direct_message_any', 'Any user on the Commune CC server')},
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='"Any user on the Commune CC server" enables users to open a Direct Message channel with any user on the server, even if they are not on any teams together. "Any member of the team" limits the ability to open Direct Message channels to only users who are in the same team.'
                        />
                    }

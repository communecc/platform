                ...
                <div className='banner warning'>
                    <div className='banner__content'>
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='<h4 class="banner__heading">Note:</h4><p>Compliance is an enterprise feature. Your current license does not support Compliance. Click <a href="http://youcommune.com"target="_blank">here</a> for information and pricing on enterprise licenses.</p>'
                        />
                    </div>
                </div>
            );
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='When true, Commune CC allows compliance reporting from the <strong>Compliance and Auditing</strong> tab. See <a href="https://docs.youcommune.com/administration/compliance.html" target="_blank">documentation</a> to learn more.'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When true, Commune CC will generate a daily compliance report.'
                        />
                    }

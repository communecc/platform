            ...
            helpText = (
                <p>
                    <FormattedHTMLMessage
                        ...
                        defaultMessage='Your slash command has been set up. The following token will be sent in the outgoing payload. Please use it to verify the request came from your Commune CC team (see <a href="https://docs.youcommune.com/developer/slash-commands.html">documentation</a> for further details).'
                    />
                </p>
            );
            tokenText = (
            ...
            helpText = (
                <p>
                    <FormattedHTMLMessage
                        ...
                        defaultMessage='Your incoming webhook has been set up. Please send data to the following URL (see <a href=\"https://docs.youcommune.com/developer/webhooks-incoming.html\">documentation</a> for further details).'
                    />
                </p>
            );
            tokenText = (
            ...
            helpText = (
                <p>
                    <FormattedHTMLMessage
                        ...
                        defaultMessage='Your outgoing webhook has been set up. The following token will be sent in the outgoing payload. Please use it to verify the request came from your Commune CC team (see <a href=\"https://docs.youcommune.com/developer/webhooks-outgoing.html\">documentation</a> for further details).'
                    />
                </p>
            );
            tokenText = (
                ...
                helpText.push(
                    <p>
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='Your OAuth 2.0 application has been set up. Please use the following Client ID and Client Secret when requesting authorization for your application (see <a href="https://docs.youcommune.com/developer/oauth-2-0-applications.html">documentation</a> for further details).'
                        />
                    </p>
                );
                helpText.push(

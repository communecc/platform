            ...
            <BackstageList
                ...
                helpText={
                    <FormattedMessage
                        ...
                        defaultMessage='Create OAuth 2.0 applications to securely integrate bots and third-party applications with Commune CC. Please see {link} to learn more.'
                        values={{
                            link: (
                                <a
                                    target='_blank'
                                    rel='noopener noreferrer'
                                    href='https://docs.youcommune.com/developer/oauth-2-0-applications.html'
                                >
                                    <FormattedMessage

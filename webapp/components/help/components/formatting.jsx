...
export default class HelpFormatting extends React.Component {
    render() {
        ...
        message.push('```\n' + localizeMessage('help.formatting.codeBlock', 'code block') + '\n```');
        message.push(localizeMessage('help.formatting.syntax', '### Syntax Highlighting\n\nTo add syntax highlighting, type the language to be highlighted after the ``` at the beginning of the code block. Commune CC also offers four different code themes (GitHub, Solarized Dark, Solarized Light, Monokai) that can be changed in **Account Settings** > **Display** > **Theme** > **Custom Theme** > **Center Channel Styles**'));
        ...
        message.push('![go syntax-highlighting](https://docs.youcommune.com/_images/syntax-highlighting-github.PNG)');
        message.push(localizeMessage('help.formatting.solirizedDarkTheme', '**Solarized Dark Theme**'));
        message.push('![go syntax-highlighting](https://docs.youcommune.com/_images/syntax-highlighting-sol-dark.PNG)');
        message.push(localizeMessage('help.formatting.solirizedLightTheme', '**Solarized Light Theme**'));
        message.push('![go syntax-highlighting](https://docs.youcommune.com/_images/syntax-highlighting-sol-light.PNG)');
        message.push(localizeMessage('help.formatting.monokaiTheme', '**Monokai Theme**'));
        message.push('![go syntax-highlighting](https://docs.youcommune.com/_images/syntax-highlighting-monokai.PNG)');
        ...
        message.push('`' + localizeMessage('help.formatting.linkEx', '[Check out Commune CC!](https://about.youcommune.com/)') + '`');
        message.push(localizeMessage('help.formatting.renders', 'Renders as:') + ' ' + localizeMessage('help.formatting.linkEx', '[Check out Commune CC!](https://about.youcommune.com/)'));
        ...
        message.push(localizeMessage('help.formatting.emojis', '## Emojis\n\nOpen the emoji autocomplete by typing `:`. A full list of emojis can be found [here](http://www.emoji-cheat-sheet.com/). It is also possible to create your own [Custom Emoji](http://docs.youcommune.com/help/settings/custom-emoji.html) if the emoji you want to use doesn\'t exist.'));

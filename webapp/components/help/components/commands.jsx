...
export default class HelpCommands extends React.Component {
    render() {
        ...
        message.push(localizeMessage('help.commands.intro', 'Slash commands perform operations in Commune CC by typing into the text input box. Enter a `/` followed by a command and some arguments to perform actions.\n\nBuilt-in slash commands come with all Commune CC installations and custom slash commands are configurable to interact with external applications. Learn about configuring custom slash commands on the [developer slash command documentation page](http://docs.youcommune.com/developer/slash-commands.html).'));
        message.push(localizeMessage('help.commands.builtin', '## Built-in Commands\nThe following slash commands are available on all Commune CC installations:'));
        message.push('![commands](https://docs.youcommune.com/_images/slashCommandsTable1.PNG)');
        ...
        message.push('![autocomplete](https://docs.youcommune.com/_images/slashCommandsAutocomplete.PNG)');

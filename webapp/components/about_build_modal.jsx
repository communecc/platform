        ...
        let learnMore = (
            <div>
                <FormattedMessage
                    ...
                    defaultMessage='Join the Commune CC community at '
                />
                <a
                    target='_blank'
                    rel='noopener noreferrer'
                    href='http://www.youcommune.com/'
                >
                    {'youcommune.com'}
                </a>
            </div>
            ...
            learnMore = (
                <div>
                    ...
                    <a
                        target='_blank'
                        rel='noopener noreferrer'
                        href='http://about.youcommune.com/'
                    >
                        {'about.youcommune.com'}
                    </a>
                </div>
            );
            ...
            >
                <Modal.Header closeButton={true}>
                    <Modal.Title>
                        <FormattedMessage
                            id='about.title'
                            defaultMessage='About Commune CC'
                        />
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <div className='about-modal__content'>
                        ...
                        <div>
                            <h3 className='about-modal__title'>{'Commune'} {title}</h3>
                    ...
                    <div className='about-modal__footer'>
                        ...
                        <div className='form-group about-modal__copyright'>
                            <FormattedMessage
                                id='about.copyright'
                                defaultMessage='Copyright 2017 Commune CC, Inc. All rights reserved'
                            />
                        </div>
                    </div>

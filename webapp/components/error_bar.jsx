    ...
    render() {
        ...
        if (message === EXPIRING_ERROR) {
            message = (
                <FormattedMessage
                    id={EXPIRING_ERROR}
                    defaultMessage='The Enterprise license is expiring on {date}. To renew your license, please contact commercial@youcommune.com'
                    values={{
            ...
            message = (
                <FormattedMessage
                    id={EXPIRED_ERROR}
                    defaultMessage='Enterprise license has expired; you have 15 days from expiry to renew the license, please contact commercial@youcommune.com for details'
                />
            );
